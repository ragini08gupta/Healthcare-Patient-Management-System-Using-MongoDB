...
const SinglePatient = () => {
 ...
 return (
   ...
   <button className="mb-4 bg-primary hover:bg-primary text-white font-bold py-2 px-4 rounded" onClick={handleGoBack}> Go Back</button>
   <button className="mb-4 bg-primaryhover:bg-primary text-white font-bold py-2 px-4 rounded" onClick={()=>{handleEditPatient(patient._id)}}> Edit Patient Details</button>
   <button className="mb-4 bg-primary hover:bg-primary text-white font-bold py-2 px-4 rounded" onClick={()=>{handlePatientMetrics(patient._id)}}> View Patient Health Metrics</button>
   </div>
