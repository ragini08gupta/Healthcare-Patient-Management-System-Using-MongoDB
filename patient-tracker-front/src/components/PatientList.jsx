        ...
        <tbody>
          {filteredPatients&&filteredPatients.length > 0? (filteredPatients.map((patient, index) => (
            ...
            >
              ...
              <td className='grid place-items-center'><button className="bg-primary hover:bg-primary text-white font-bold py-2 px-4 text-xs rounded" onClick={()=>{handleAddAppointment(patient)}}> Add</button>
</td>
            </tr>
