  ...
  <Form method='post' onSubmit={handleSubmit}>
    ...
    <div className='flex flex-wrap gap-3 items-center justify-center'>
      ...
      {formData.medicalHistory.allergies.map((allergy, index)=>{
          return <React.Fragment key={`allergy-${index}`}>
                  ...
                  {index > 0 && (
                    <button type='button' className="mb-4 bg-primary hover:bg-primary mt-2 text-white font-bold py-2 px-4 rounded" onClick={() => removeField('medicalHistory.allergies', index)}>Remove Allergy</button>
                  )}
                </React.Fragment>


      })}
      <button type='button'className="mb-4 bg-primary hover:bg-primary text-white font-bold py-2 px-4 rounded block mt-2"  onClick={() => addField('medicalHistory.allergies','')}>Add Allergy</button>
      ...
      {formData.medicalHistory.chronicConditions.map((chronicCondition, index)=>{
          return  <React.Fragment key={`cc-${index}`}>
                  ...
                  {index > 0 && (
                    <button type='button' className="mb-4 bg-primary hover:bg-primary mt-2 text-white font-bold py-2 px-4 rounded" onClick={() => removeField('medicalHistory.chronicConditions', index)}>Remove Chronic Conditions</button>
                  )}
                 </React.Fragment>
      })}
      <button type='button'className="mb-4 bg-primary hover:bg-primary text-white font-bold py-2 px-4 rounded block mt-2"  onClick={() => addField('medicalHistory.chronicConditions','')}>Add Chronic Conditions</button>
      {formData.medicalHistory.surgeries.map((surgery, index)=>{
          return <React.Fragment key={`surgeries-${index}`}>
                  ...
                  {index > 0 && (
                    <button type='button' className="mb-4 bg-primary hover:bg-primary mt-2 text-white font-bold py-2 px-4 rounded" onClick={() => removeField('medicalHistory.surgeries', index)}>Remove Surgery</button>
                  )}
                 </React.Fragment>
      })}
      <button type='button'className="mb-4 bg-primary hover:bg-primary text-white font-bold py-2 px-4 rounded block mt-2"  onClick={() => addField('medicalHistory.surgeries','')}>Add Surgery</button>
      ...
      <div key={`medication-${index}`}  className='flex justify-around items-center gap-4'>
        ...
        {index > 0 && (
          <button type="button" className="bg-primary hover:bg-primary text-white font-bold py-2 px-4 rounded block mt-5"  onClick={() => removeField('medications', index)}>Remove Medication</button>
        )}
      </div>
    ))}
    {/* Button to add a new medication */}
    <button type="button" className="mb-4 bg-primary hover:bg-primary text-white font-bold py-2 px-4 rounded block mt-2"  onClick={() => addField('medications', {
      name: '',
      dosage: '',
      frequency: '',
      ...
      <div key={`vaccination-${index}`}  className='flex justify-around items-center gap-4'>
        ...
        {index > 0 && (
          <button type="button" className=" bg-primary hover:bg-primary text-white font-bold py-2 px-4 rounded block mt-5"  onClick={() => removeField('vaccinations', index)}>Remove Vaccination</button>
        )}
      </div>
    ))}
    {/* Button to add a new vaccination */}
    <button type="button" className="mb-4 bg-primary hover:bg-primary text-white font-bold py-2 px-4 rounded block mt-2"  onClick={() => addField('vaccinations', {
      name: '',
     date:''
    ...
    <h4 className='text-center text-xl mt-5 font-bold'>Prescriptions</h4>
      ...
      <div key={`prescription-${index}`}  className='flex justify-around items-center gap-4'>
        ...
        {index > 0 && (
          <button type="button" className=" bg-primary hover:bg-primary text-white font-bold py-2 px-4 rounded block mt-5"  onClick={() => removeField('prescriptions', index)}>Remove Prescription</button>
        )}
      </div>
    ))}
    {/* Button to add a new prescription */}
    <button type="button" className="mb-4 bg-primary hover:bg-primary text-white font-bold py-2 px-4 rounded block mt-2"  onClick={() => addField('prescriptions', {
      name: '',
      dosage:'',
      instructions:''
    ...
    <h4 className='text-center text-xl mt-5 font-bold'>Billing Invoice</h4>
      ...
      <div key={`invoices-${index}`} className='flex justify-around items-center gap-4'>
        ...
        {index > 0 && (
          <button type="button" className="bg-primary hover:bg-primary text-white font-bold py-2 px-4 rounded block mt-5"  onClick={() => removeField('billing.invoices', index)}>Remove Invoice</button>
        )}
      </div>
    ))}
    {/* Button to add a new invoice */}
    <button type="button" className="mb-4 bg-primary hover:bg-primary text-white font-bold py-2 px-4 rounded block mt-2"  onClick={() => addField('billing.invoices', {
      invoiceNumber: '',
      amount:'',
      status:''
    })}>Add Invoice</button>
    ...
    <h4 className='text-center text-xl mt-5 font-bold'>Insurance Claims</h4>
      ...
      <div key={`insuranceClaims-${index}`}  className='flex justify-around items-center gap-4'>
        ...
        {index > 0 && (
          <button type="button" className=" bg-primary hover:bg-primary text-white font-bold py-2 px-4 rounded block mt-5"  onClick={() => removeField('billing.insuranceClaims', index)}>Remove Insurance claim</button>
        )}
      </div>
    ))}
    <button type="button" className="mb-4 bg-primary hover:bg-primary text-white font-bold py-2 px-4 rounded block mt-2"  onClick={() => addField('billing.insuranceClaims', {
      claimNumber: '',
      amount:'',
      status:''
